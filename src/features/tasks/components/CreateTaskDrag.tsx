  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button className=" mt-4 absolute bottom-0 left-0 flex items-center gap-2 m-4 font-semibold  hover:scale-x-105 transition-all duration-300">
          <HiPlus></HiPlus> <span>Add card</span>
        </button>
      </DialogTrigger>
      <DialogContent className="w-[500px] bg-[var(--color-grey-0)] border border-[var(--color-grey-0)]">
        <DialogHeader>
